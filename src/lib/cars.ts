...
export const CARS: Car[] = [
  toyota(
    ...
    5,
    {
      hybrid: true,
      defaultTrim: "xse",
      defaultColor: "wind-chill-black-roof",
      ...
      specs: [
        { label: { he: "מנוע", en: "Engine" }, value: { he: "2.5L הייבריד 4 צילינדרים", en: "2.5L 4-cyl hybrid" } },
        { label: { he: "הספק", en: "Power" }, value: { he: "225–232 כ״ס משולב", en: "225–232 hp combined" } },
        { label: { he: "הנעה", en: "Drivetrain" }, value: { he: "היברידית · FWD / AWD", en: "Hybrid · FWD / AWD" } },
        { label: { he: "תיבה", en: "Transmission" }, value: { he: "eCVT", en: "eCVT" } },
      ...
      highlights: [
        { he: "היברידית בכל רמות הגימור — בלי מנוע בנזין בלבד", en: "Hybrid across every trim — no gas-only Camry" },
        { he: "AWD זמין מ־SE Upgrade ומעלה", en: "AWD from SE Upgrade up" },
        { he: "Nightshade עם גלגלי 19״ וחבילת שחור", en: "Nightshade with 19\" wheels and blacked-out trim" },
        { he: "XSE עם שני גוונים ופנים Cockpit Red", en: "XSE two-tone paint and Cockpit Red interior" },
        { he: "יבוא מקביל מארה״ב עם ליווי בעברית ובאנגלית", en: "US parallel import, Hebrew and English support" },
      ],
    },
  ),
  toyota(
